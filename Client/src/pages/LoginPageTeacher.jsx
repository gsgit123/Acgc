...
const LoginPageTeacher = () => {
  ...
  const { login, isLoggingIn } = useTAuthStore();
    ...
    >
      <div className="w-full max-w-md p-8 bg-[#0f172a] rounded-xl shadow-2xl text-white font-['Nunito']">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-1 text-sky-400">Welcome Back, Teacher</h1>
          <p className="text-gray-400">Sign in to your teacher account</p>
        </div>
        ...
        <div className="text-center mt-6 text-gray-400 text-sm">
          ...
          <Link to="/SignupPageTeacher" className="text-sky-400 hover:underline">
            Create account
          </Link>
        </div>
      </div>
